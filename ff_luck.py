...
stats = { 'reason will prevail': {
              'scores': [ 126.14, 74.46, 131.26, 118.98, 113.82, 111.98, 151.54, 173.06 ],
              'record': '5-3-0',
          },
          'bad ass boys': {
              'scores': [ 65.24, 111.06, 126.22, 121.20, 139.06, 82.96, 104.10, 127.96 ],
              'record': '7-1-0', 
          },
          'rusty scuppers': {
              'scores': [ 131.36, 140.20, 138.80, 132.18, 63.92, 112.78, 94.26, 139.62, ],
              'record': '6-2-0',
          },
          'geos sad sacks': {
              'scores': [ 120.74, 111.44, 87.86, 110.58, 118.14, 110.54, 126.56, 99.48, ],
              'record': '4-4-0',
          },
          'clem fandango': {
              'scores': [ 93.16, 96.08, 101.88, 93.54, 121.24, 100.42, 100.58, 82.18, ],
              'record': '4-4-0',
          },
          'fairy quadfathers': {
              'scores': [ 105.96, 84.72, 113.22, 85.64, 70.58, 96.64, 100.5, 93.66, ],
              'record': '1-7-0',
          },
          'flash them tds': {
              'scores': [ 97.90, 89.82, 138.28, 114.16, 98.52, 103.00, 86.26, 105.26, ],
              'record': '2-6-0',
          },
          'lets see paul allens team': {
              'scores': [ 56.38, 138.48, 118.42, 65.9, 128.38, 105.30, 112.06, 114.42, ],
              'record': '5-3-0',
          },
          'quadfathers': {
              'scores': [ 90.14, 124.80, 127.98, 123.42, 122.84, 54.74, 122.06, 90.44, ],
              'record': '3-5-0',
          },
          'dinkin flickas': {
              'scores': [ 110.14, 108.84, 123.56, 101.4, 127.18, 69.92, 53.8, 96.76, ],
              'record': '3-5-0',
          },
        }
